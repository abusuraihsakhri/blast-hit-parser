"""
FastAPI REST API Server for Blast Hit Parser.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "blast-hit-parser", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
